...
public class ApiParameterError {
    ...
    public static ApiParameterError parameterError(final String defaultUserMessage,
                                                   final String parameterName,
                                                   final Object... defaultUserMessageArgs) {
        return new ApiParameterError("error.msg.validation.exist",
                defaultUserMessage, defaultUserMessageArgs, parameterName, null);
    }
